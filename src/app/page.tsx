...
const starterQuestions: QuestionInput[] = [
  {
    text: "У Франції можна легально вийти заміж за...",
    correctAnswer: "Мертву людину",
    wrongAnswer: "Штучний інтелект",
  },
  { text: "Слово «лемур» походить від латинського слова, що означає…", correctAnswer: "привид", wrongAnswer: "нічна мавпа" },
  {
    text: "Поет Фрідріх Шиллер не міг працювати, якщо в шухляді робочого столу не було",
    correctAnswer: "гнилих яблук",
    wrongAnswer: "окулярів",
  },
  { text: "Мурахи фуражири вміють ...", correctAnswer: "складатись у пліт через річку", wrongAnswer: "Рахувати свої кроки" },
  { text: "Вигода на галицькому діалекті це", correctAnswer: "туалет", wrongAnswer: "урожай" },
  {
    text: "Тигри та леви можуть годинами тертись об дерево, на якому є",
    correctAnswer: "парфуми Кельвін Кляйн",
    wrongAnswer: "Фрукти",
  },
  { text: "Талісман GitHub — це суміш…", correctAnswer: "кота і восьминога", wrongAnswer: "кота і павука" },
  {
    text: "Нікола Тесла міг відмовитися розмовляти з жінкою, якщо вона носила…",
    correctAnswer: "перли",
    wrongAnswer: "червоний капелюх",
  },
  {
    text: "У Кенії існує традиція, де чоловік після шлюбу протягом місяця має",
    correctAnswer: "носити жіночий одяг",
    wrongAnswer: "Готувати всій сім'ї",
  },
  {
    text: "Вінстон Черчиль казав: \"Дурень той, хто ніколи не ...\"",
    correctAnswer: "Змінює своєї думки",
    wrongAnswer: "визнає своїх помилок",
  },
  { text: "Ділектне слово заколот на Поліссі та Волині означає", correctAnswer: "палиця", wrongAnswer: "Компот" },
  {
    text: "Щоб не відволікатися від навчання, Демосфен одного разу…",
    correctAnswer: "поголив половину голови",
    wrongAnswer: "прикував себе до столу",
  },
  {
    text: "В екстримальних випадках замість плазми крові можна використати",
    correctAnswer: "Воду з кокосу",
    wrongAnswer: "дистильовану воду",
  },
  {
    text: "Переможцю марафону на Олімпіаді 1904 року під час забігу давали…",
    correctAnswer: "стрихнін і бренді",
    wrongAnswer: "каву із сирими яйцями",
  },
  {
    text: "Під час знаменитої \"тюльпанової лихоманки\" один моряк зробив щось, за що його посадили",
    correctAnswer: "з’їв цибулину тюльпана",
    wrongAnswer: "обміняв корабель на букет тюльпанів",
  },
  { text: "Із понад тисячі видів кажанів кров’ю харчуються", correctAnswer: "3 види", wrongAnswer: "50% видів" },
  { text: "Чарльз Дарвін у молодості навчався, щоб стати…", correctAnswer: "священником", wrongAnswer: "військовим моряком" },
  { text: "Хохлаті дикобрази іноді мають запах, схожий на…", correctAnswer: "свіжий попкорн", wrongAnswer: "карамельне яблуко" },
];
